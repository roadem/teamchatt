...
public class BitmapUtils {
    ...
    @Nullable
    public static Bitmap getBitmap(Image image, int rowStrideY, int rowStrideUV) {

        YuvImage yuvImage = new YuvImage(YUV_420_888toNV21(image), ImageFormat.NV21, image.getWidth(), image.getHeight(), new int[] { rowStrideY, rowStrideUV, rowStrideUV });
